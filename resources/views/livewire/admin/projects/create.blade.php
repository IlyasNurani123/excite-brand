                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="project_name" class="form-control" id="recipient-name"
                                    required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="file" wire:model="project_image" id="upload{{ $iteration }}"
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" wire:model="project_description" id="recipient-name"
                                    rows="4"></textarea>
