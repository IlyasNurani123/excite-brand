                        ...
                        <div class="col-sm-12 md-6 text-center">
                            @if (session()->has('message'))
                                <div class="alert {{ Session::get('alert-class') }}" role="alert">
                                    <a href="#" class="close mdi mdi-window-close" data-dismiss="alert"
                                        aria-label="close"></a>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-8 col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model="slider_title" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" wire:model="description" id="recipient-name"
                                        rows="2"></textarea>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" wire:model="images" class="form-control" id="recipient-name">
