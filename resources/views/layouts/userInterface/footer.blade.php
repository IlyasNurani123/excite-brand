                ...
                <div class="address-details">
                    ...
                    <div class="footer-contacts">
                        <div class="our-address my-4">
                            <p class="uk-office-description"> Address: <br>
                                83 Ducie St, Manchester, M1 2JQ, UK</p>
                        </div>
            ...
            <div class="col-sm-6 col-md-3 col-col-lg-3">
                <div class="address-details">
                    ...
                    <div class="footer-contacts">
                        <div class="our-address my-4">
                            <p class="uk-office-description"> Address: <br>
                                Liberty Village, 60 Atlantic Avenue, Toronto, M6K 1X9, Canada</p>
                        </div>
                        <div class="our-phone my-4">
                            <p class="office-contact"><span>Phone:</span><br>
                                647-952-8485</p>
            ...
            <div class="col-sm-6 col-md-3 col-col-lg-3">
                <div class="address-details">
                    ...
                    <div class="footer-contacts">
                        <div class="our-address my-4">
                            <p class="uk-office-description"> Address: <br>
                                57 West, 57th Street New York, USA</p>
                        </div>
                        <div class="our-phone my-4">
                            <p class="office-contact"><span>Phone:</span><br>
                                313-462-7362</p>
